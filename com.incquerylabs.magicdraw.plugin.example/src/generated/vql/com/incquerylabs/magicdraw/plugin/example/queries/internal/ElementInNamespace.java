...
public final class ElementInNamespace extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.plugin.example.queries.internal.ElementInNamespace (visibility: PUBLIC, simpleName: ElementInNamespace, identifier: com.incquerylabs.magicdraw.plugin.example.queries.internal.ElementInNamespace, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.plugin.example.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
